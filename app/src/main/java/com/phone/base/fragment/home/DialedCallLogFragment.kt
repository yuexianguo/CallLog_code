...
import com.phone.base.bean.DIAL_TYPE_DIALED_CALL
...
class DialedCallLogFragment : BaseFragment() {
    ...
    override fun onHiddenChanged(hidden: Boolean) {
        ...
        Log.d(T.TAG,"dialed call onHiddenChanged hidden=$hidden")
        if (!hidden) {
            updateData()
        }
    }
    ...
    private fun updateData() {
        ...
        mPhoneHistoryList.addAll(PhoneInfoManager.instance.phoneInfo.phoneHistoryItemList.filter { it.dialType == DIAL_TYPE_DIALED_CALL })
