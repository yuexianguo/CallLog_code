...
const val TAG_RECEIVED_CALL_FRAGMENT = "ReceivedCallLogFragment"

class ReceivedCallLogFragment : BaseFragment() {
    ...
    private fun updateData() {
        ...
        mPhoneHistoryList.addAll(PhoneInfoManager.instance.phoneInfo.phoneHistoryItemList.filter { it.dialType == DIAL_TYPE_RECEIVED_CALL })
